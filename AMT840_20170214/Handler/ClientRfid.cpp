...
void CClientRfid::OnDataReceive(CString strData)
{
	...
	strTemp = OnDataItemAnalysis(strData, _T("READ"));

	if (strTemp == _T("OK"))
	{
		m_strRfidData[RF_CARRIER_ID] = OnDataItemAnalysis(strData, _T("CARRIER"));
		m_strRfidData[RF_EQP_ID]	 = OnDataItemAnalysis(strData, _T("EQP"));
		m_strRfidData[RF_QTY]		 = OnDataItemAnalysis(strData, _T("QTY"));
		m_strRfidData[RF_QTY_T]		 = OnDataItemAnalysis(strData, _T("QTY_T"));
		m_strRfidData[RF_LOT_ID_J]   = OnDataItemAnalysis(strData, _T("LOT_ID_J"));
		m_strRfidData[RF_STEP]       = OnDataItemAnalysis(strData, _T("STEP"));
		m_strRfidData[RF_LOT_TYPE]   = OnDataItemAnalysis(strData, _T("LOT_TYPE"));
		m_strRfidData[RF_PART_ID]    = OnDataItemAnalysis(strData, _T("PART"));
		m_strRfidData[RF_PKG_CODE]   = OnDataItemAnalysis(strData, _T("PKG_CODE"));
		m_strRfidData[RF_NONE_1]     = OnDataItemAnalysis(strData, _T("NONE_1"));
		m_strRfidData[RF_LOT_ID_M]   = OnDataItemAnalysis(strData, _T("LOT_ID_M"));
		m_strRfidData[RF_CNT]        = OnDataItemAnalysis(strData, _T("CNT"));
		m_strRfidData[RF_FLAG]       = OnDataItemAnalysis(strData, _T("FLAG"));
		m_strRfidData[RF_REJECT]     = OnDataItemAnalysis(strData, _T("REJECT"));
		m_strRfidData[RF_BIN]        = OnDataItemAnalysis(strData, _T("BIN"));
		m_strRfidData[RF_NONE_2]     = OnDataItemAnalysis(strData, _T("NONE_2"));
		m_strRfidData[RF_TRAY_QTY]   = OnDataItemAnalysis(strData, _T("TRAY_QTY"));
...
CString CClientRfid::OnDataItemAnalysis(CString strMsg, CString strFind)
{
	CString strData = _T("");
	CString strHead;
	int length;
