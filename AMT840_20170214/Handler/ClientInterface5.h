...
#include "Variable.h"
typedef struct _INTER_CLIENT_QUEUE_5_
{
	int			m_nRear;
	int			m_nFront;
	int			m_nCount;
...
} INTER_CLIENT_QUEUE_5, *P_INTER_CLIENT_QUEUE_5;

class CClientInterface5
{
public:
	int							m_nRetry;
	int							m_nCommStep;
	...
	P_INTER_CLIENT_QUEUE_5		m_pQueueInter5;
...
public:
	CClientInterface5(void);
	~CClientInterface5(void);
};

extern CClientInterface5 clsInterC5;