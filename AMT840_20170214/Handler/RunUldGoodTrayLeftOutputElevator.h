...
// CRunUldGoodTrayLeftOutputElevator 명령 대상입니다.

class CRunUldGoodTrayLeftOutputElevator : public CObject
{
public:
	CRunUldGoodTrayLeftOutputElevator();
	virtual ~CRunUldGoodTrayLeftOutputElevator();
...
public:
	...
	void			Set_GoodStackerLeftTray_UpDown( int nOnOff );
	int				Chk_GoodStackerLeftTray_UpDown( int nOnOff );
...
public:
	...
	DWORD			m_dwWaitStackerLeftUpDown[3];
	bool			m_bStackerLeftUpDown;
...
extern CRunUldGoodTrayLeftOutputElevator clsRunUldGoodTrayLeftOutputElevator;
