...
#define BUFF_CW_TURN	1 // right 방향 turn으로 Left Test site와 작업 가능 
#define BUFF_CCW_TURN	2 // left 방향 turn으로 rightt Test site와 작업 가능 

#define TESTSITE_LEFT		1 //test site 영역 중 left site 작업 중(test duct 1,2,3,4 영역)
#define TESTSITE_RIGHT      2 //test site 영역 중 right site 작업 중(test duct 5,6,7,8 영역)
...
#define IO_STABLE_LIMIT		2000 //james 2016.0812
#define IO_STABLE_WAIT		100 //100ms 안정시간 준다 
#define IO_CONVEYOR_WAIT_STABLE    2000 //Conveyor AC motor 가동후 밀착을 위해 더 돌리는 시간 
#define IO_CONVEYOR_WAIT_LIMIT	10000 //10초 
#define	MOT_ELE_MOVE_WAITLIMIT	20000	//20초 
