...
void CDialog_About::OnSetUserControl() 
{
	...
	mp_imgAbout.AddTextLine(_T("AMT840(CDIMM)"));
	mp_imgAbout.AddTextLine(_T(""));
	...
	mp_imgAbout.AddTextLine(_T(""));
	mp_imgAbout.AddTextLine(_T(""));
	mp_imgAbout.AddTextLine(_T("Manufacturing Date : 2016-06-07"));
	mp_imgAbout.AddTextLine(_T("Update Info        : 2016-06-07"));
	...
	mp_imgAbout.AddTextLine(_T(""));
	mp_imgAbout.AddTextLine(_T("Copyright(C) 2016.06.07"));
...
{
	CString sUpdateInfoFile = _T("C:\\AMT840\\System\\Update.Info");
