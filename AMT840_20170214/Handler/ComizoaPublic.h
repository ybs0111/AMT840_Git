...
/////////////////////////////////////////////////////////////////////////////////////////////////////////////
// AMT Motor 제어함수 관련 버젼 리스트 (2016.0819부터 정리 시작)
// 앞으로는 이런 방법으로 버젼 관리 바람.
/////////////////////////////////////////////////////////////////////////////////////////////////////////////
//1. 2016.0819 james 추가 
//    - mn_type[BD_MAX_MOTOR]; //james 2016.0819 추가  Servo 또는 step motor 관련 셋팅 확인 건. (Inposition, home check 방법, comm처리 문제로 추가
//    - void Set_MotorType_Init(int n_Axis, int nServoStep_Type); //추가 
//    - 각 싱글, 다중 motor check 함수에 servo mtoro미면 inposition 은 무조건 체크하게 추가 
//	  - Motor Start 함수 사용시 반듯이 리턴값이 BD_GOOD 일때만 Check 하수로 이동으로 해야 한다.
//    - 각 싱글, 다중 motor Start시 목적지의 값과 현재값이 0.01mm 이내로 같으면, 동작 Safety 함수 체크 문제로  Start 명령을 진행하지 않고 바로 BD_GOOD을 리턴하게 처리함(james 2016.0819 현재 위치와 목적위치가 0.01mm 값 이내이면 동작하지 말자)
//2. 2016.0819 ViboX추가
//	  - 모터 Type 지정지 Inposition Enable 자동 설정.
//    - 알람관련 변수 내제시킴. 
//3.
//4.
//5.
...
#define MOT_TIMEOUT			120000 //james 2016.1004 90000   //1분의 time out를 가지고 동작한다  //홈 체크시 사용 
...
public:
	...
	int nCountMode;
	int nTypeMode;
	int nAlarmAssignSection;
 
// Operations
public:
	///////////////////////////////////////////////////
	//james 2016.0819 모터 함수 다시 졍렬 및 내용 추가 
	///////////////////////////////////////////////////

	///////////////////////////////////////////////////
	//Motor Initialize 시 사용하는 함수//
	//반듯이 처음 초기화시 한번 사용해야 할 함수 
	///////////////////////////////////////////////////
	int Initialize_MotBoard(CString s_file);
	void Close_MotBoard();//보드 클로즈 
	void Set_MotorType_Init(int n_Axis, int nServoStep_Type); //0:Servo , 1:Step //james 2016.0818 추가  Servo 또는 step motor 관련 셋팅 확인 건. (Inposition, home check 방법, comm처리 문제로 추가
