...
void CServerVnR::OnMakeData(CString strMsg)
{
...
// 		}
// 
// 		st_basic_info.nMCID = nMcID;
// 		st_basic_info.dVolt[m_Cnt] = dVolt;
// 		st_basic_info.dResistance[m_Cnt] = dResistance;
		m_strMsg[m_Cnt] = strMsg;
		m_Cnt++;
		if (m_Cnt >= 10)
		{
			for (int i =0; i<10; i++)
			{
				st_basic_info.strGmeMsg[i] = m_strMsg[i];
			}	
			m_Cnt = 0;
		}
