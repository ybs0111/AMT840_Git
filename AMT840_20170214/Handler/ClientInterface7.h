...
#include "Variable.h"
typedef struct _INTER_CLIENT_QUEUE_7_
{
	int			m_nRear;
	int			m_nFront;
	int			m_nCount;
...
} INTER_CLIENT_QUEUE_7, *P_INTER_CLIENT_QUEUE_7;

class CClientInterface7
{
public:
	int							m_nRetry;
	int							m_nCommStep;
	...
	P_INTER_CLIENT_QUEUE_7		m_pQueueInter7;
...
public:
	CClientInterface7(void);
	~CClientInterface7(void);
};

extern CClientInterface7 clsInterC7;
