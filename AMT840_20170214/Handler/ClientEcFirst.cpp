...
void CClientEcFirst::OnMessageWrite(CString strMsg)
{
	...
	if (m_hMemMapEcFirst != NULL && m_pQueueEcFirst != NULL)
	{
		...
		if (m_pQueueEcFirst->m_nRear >= 50) m_pQueueEcFirst->m_nRear = 0;
...
CString	CClientEcFirst::OnMessageRead()
{
	...
	if (m_hMemMapEcFirst!= NULL && m_pQueueEcFirst != NULL)
	{
		if (m_pQueueEcFirst->m_nCount > 0 )
		{
			...
			if (m_pQueueEcFirst->m_nFront >= 50) m_pQueueEcFirst->m_nFront = 0;
...
void CClientEcFirst::OnDataAnalysis(CString strMsg)
{
	...
	if (strFunc == _T("LOTDISPLAY"))
	{
		...
		if (strData == _T("OK"))
		{
			st_lot_display_info[0].strLotNo			= OnDataItemAnalysis(0, 0, strMsg, _T("LOTID"));
			st_lot_display_info[0].strPartNo		= OnDataItemAnalysis(0, 0, strMsg, _T("PARTID"));
			st_lot_display_info[0].nQty				= _wtoi(OnDataItemAnalysis(0, 0, strMsg, _T("QTY")));
			st_lot_display_info[0].strCycleID		= OnDataItemAnalysis(0, 0, strMsg, _T("CYCLEID"));
			st_lot_display_info[0].strStepCnt		= OnDataItemAnalysis(0, 0, strMsg, _T("STEPCNT"));
			st_lot_display_info[0].strRetestKind	= OnDataItemAnalysis(0, 0, strMsg, _T("RETESTKIND"));
			st_lot_display_info[0].strRetestRes		= OnDataItemAnalysis(0, 0, strMsg, _T("RETESTRES"));
			st_lot_display_info[0].strOneShotFlag	= OnDataItemAnalysis(0, 0, strMsg, _T("ONESHOTFLAG"));
			st_lot_display_info[0].strTier			= OnDataItemAnalysis(0, 0, strMsg, _T("TIER"));
			st_lot_display_info[0].strOptcode		= OnDataItemAnalysis(0, 0, strMsg, _T("OPTION"));
			//st_lot_display_info[0].strFabSite		= OnDataItemAnalysis(0, 0, strMsg, _T("FAB_SITE"));
			//kwlee 2017.0105
			st_lot_display_info[0].strFabSite		= OnDataItemAnalysis(0, 0, strMsg, _T("FAB"));
			st_lot_display_info[0].strReworkCnt		= OnDataItemAnalysis(0, 0, strMsg, _T("REWORKCNT"));
	...
	else if (strFunc == _T("SCRAP_INFO"))
	{
		...
		if (strData == _T("OK"))
		{
			st_lot_display_info[0].nScrapCnt = 0;
			...
			if (nCount > 0)
			{
				for (i=0; i < nCount; i++)
				{
					...
					st_lot_display_info[0].strScrapCode[st_lot_display_info[0].nScrapCnt]	= OnDataItemAnalysis(0, 0, strData, _T("SCRAP_CODE"));
					st_lot_display_info[0].strScrapSerial[st_lot_display_info[0].nScrapCnt]	= OnDataItemAnalysis(0, 0, strData, _T("SERIAL"));
					st_lot_display_info[0].nScrapCnt++;
				}
			}
...
void CClientEcFirst::OnEqpID(CString strEqpID)
{
	m_strEqpID = strEqpID;
}


void CClientEcFirst::OnEcLotDisplay(CString strLotNo, CString strOperID)
{
	CString strTemp;
	CString strData;
	CString strMsg;
...
void CClientEcFirst::OnEcLotStart(CString strLotNo, CString strOperID, int nSocket)
{
	CString strTemp;
	CString strData;
	CString strMsg;
...
void CClientEcFirst::OnEcOnlineEnd(CString strOperID, tagLOT_DISPLAY_INFO lot_display)
{
	CString strTemp;
	CString strData;
	CString strMsg;
...
void CClientEcFirst::OnEcLotEnd(CString strLotNo, CString strOperID, CString strSplitLotNo, int nPass, int nFail)
{
	CString strTemp;
	CString strData;
	CString strMsg;
...
void CClientEcFirst::OnEcLotCancel(CString strLotNo, CString strOperID)
{
	CString strTemp;
	CString strData;
	CString strMsg;
...
void CClientEcFirst::OnEcScrapInfo(CString strLotNo)
{
	CString strTemp;
	CString strData;
	CString strMsg;
...
void CClientEcFirst::OnEcDeleteScrap(CString strLotNo, CString strSerial)
{
	CString strTemp;
	CString strData;
	CString strMsg;
