...
#import "AMTVisionDLL.tlb" no_namespace named_guids
...
BOOL AMTVClassWrapper::Result(double *OffsetX, double *OffsetY)
{
	if(NULL != mp_VisionClass)
	{
		return mp_VisionClass->AMTV_Result(OffsetX, OffsetY);
	}
	return FALSE;
}
