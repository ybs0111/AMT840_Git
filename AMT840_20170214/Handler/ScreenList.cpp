...
void CScreenList::OnInitGridData()
{
	//2015.02.10
	CString strTmp;
	CString strHead[32] = {_T("Run Dvc LdBuffer"),						_T("Run Dvc UldBuffer"),				_T("Run Empty Stacker Elevator"),			_T("Run Empty Tray Transfer "),				_T("Run LdTray InputShifter Conveyor"),
						   _T("Run LdTray Plate "),						_T("Run LdUldRobot Place"),				_T("Run LdUldRobot Pick"),					_T("Run LdTray StackerElevator"),			_T("Run RejectTray FrontStacker Elevator"),
						   _T("Run RejectTray RearStacker Elevator"),	_T("Run RejectTray Stacker Elevator"),	_T("Run RejectTray Transfer"),				_T("Run TestSitePart1"),					_T("Run TestSitePart2"),
						   _T("Run TestSitePart3"),						_T("Run TestSitePart4"),				_T("Run TestSitePart5"),					_T("Run TestSitePart6"),					_T("Run TestSitePart7"),
						   _T("Run TestSitePart8"),						_T("Run TestSite RetestBuffer_Left"),	_T("Run TestSite RetestBuffer_Right"),		_T("Run TestSiteRobot"),					_T("Run TestSiteRobot DVC Pick"),		
						   _T("Run TestSiteRobot DVC Place"),			_T("Run TestSiteRobot Bin Sort Place"),	_T("Run UldGoodTray Left OutputElevator"),	_T("Run UldGoodTray Right OutputElevator"),	_T("CCtlBd_Library Elevator_Job_Move_Pos"),  
						   _T("Run LdUld Robot Run Move"),				_T("CRun LdTray Stacker Elevator Job_Move_Pos")};	   
	...
	if(nResponse == IDOK)
	{
		...
		for (i=0; i<50; i++)
		{
			...
			if (st_other_info.strHistoryStep[i] != _T(""))
			{
				...
				strTemp.Format(_T("THREAD ID[%d] %s \r\n"),i , st_other_info.strHistoryStep[i]);
