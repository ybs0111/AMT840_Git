...
#include "Variable.h"
typedef struct _INTER_CLIENT_QUEUE_1_
{
	int			m_nRear;
	int			m_nFront;
	int			m_nCount;
...
} INTER_CLIENT_QUEUE_1, *P_INTER_CLIENT_QUEUE_1;

class CClientInterface1
{
public:
	int							m_nRetry;
	int							m_nCommStep;
	...
	P_INTER_CLIENT_QUEUE_1		m_pQueueInter1;
...
public:
	CClientInterface1(void);
	~CClientInterface1(void);
};

extern CClientInterface1 clsInterC1;