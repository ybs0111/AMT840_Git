...
#include "Variable.h"
typedef struct _INTER_CLIENT_QUEUE_4_
{
	int			m_nRear;
	int			m_nFront;
	int			m_nCount;
...
} INTER_CLIENT_QUEUE_4, *P_INTER_CLIENT_QUEUE_4;

class CClientInterface4
{
public:
	int							m_nRetry;
	int							m_nCommStep;
	...
	P_INTER_CLIENT_QUEUE_4		m_pQueueInter4;
...
public:
	CClientInterface4(void);
	~CClientInterface4(void);
};

extern CClientInterface4 clsInterC4;