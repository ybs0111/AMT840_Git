...
#include "Variable.h"
typedef struct _INTER_CLIENT_QUEUE_3_
{
	int			m_nRear;
	int			m_nFront;
	int			m_nCount;
...
} INTER_CLIENT_QUEUE_3, *P_INTER_CLIENT_QUEUE_3;

class CClientInterface3
{
public:
	int							m_nRetry;
	int							m_nCommStep;
	...
	P_INTER_CLIENT_QUEUE_3		m_pQueueInter3;
...
public:
	CClientInterface3(void);
	~CClientInterface3(void);
};

extern CClientInterface3 clsInterC3;