...
// CRunRejectTrayRearStackerElevator 명령 대상입니다.

class CRunRejectTrayRearStackerElevator : public CObject
{
public:
	CRunRejectTrayRearStackerElevator();
	virtual ~CRunRejectTrayRearStackerElevator();
...
extern CRunRejectTrayRearStackerElevator clsRunRejectTrayRearStackerElevator;
