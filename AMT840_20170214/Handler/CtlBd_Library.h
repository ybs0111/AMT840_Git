...
public:		
	...
	int		m_npTestSitePos_Info[2]; //[0]:테스트 사이트 위치정보, [1]:테스트 소켓 8개중, left, right 정보
...
public:
	...
	int Single_Move(int n_RunMethod, int n_MotorNum, double d_MovePos, int n_SpeedRate); //2016.0911 james =100);	// 입력된 위치로 모터 이동
	///////////////////////////////////////////////////
